		...
		<div class="container-fluid">
			<div class="side-body">
				<div class="page-title"> <span class="title">学科竞赛管理</span>
					<div class="description">在此界面查看、修改评判标准</div>
				</div>
				<div class="row">
					<div class="col-xs-12">
						<div class="card">
							...
							<c:if test="${empty requestScope.alljudgcrilist}">
								<h4 style="display:block;text-align:center">没有评判标准!</h4>
							</c:if>
							...
							<div class="card-body">
								<table class="datatable table table-striped" cellspacing="0" width="100%">
									...
									<tbody>
										<!-- 注释 JSTL 循环 -->
										<c:forEach items="${requestScope.alljudgcrilist}" var="alljclist">
										<tr>
											<td>${alljclist.id }</td>
											<td>${alljclist.award }</td>
											<td>${alljclist.affirmation }</td>
											<td>&nbsp;&nbsp;${alljclist.cricredit }</td>
											<td>&nbsp;&nbsp;${alljclist.cribonus }</td>
											<td>${alljclist.criworkload }</td>
											<td><a href="${pageContext.request.contextPath }/criteria/TzXiuGaiCriteria?Id=${alljclist.id }">修改</a></td>
										</tr>
										</c:forEach>
									</tbody>
								</table>
