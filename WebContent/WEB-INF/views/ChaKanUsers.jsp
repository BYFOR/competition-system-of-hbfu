...
<div class="app-container">
	<div class="row content-container">
		...
		<div class="container-fluid">
			<div class="side-body">
				<div class="page-title"> <span class="title">管理员管理</span>
					<div class="description">在此界面查看用户</div>
				</div>
				<div class="row">
					<div class="col-xs-12">
						<div class="card">
							...
							<c:if test="${empty requestScope.alluserlist}">
								<h4 style="display:block;text-align:center">没有用户!</h4>
							</c:if>
							...
							<div class="card-body">
								<table class="datatable table table-striped" cellspacing="0" width="100%">
									...
									<tbody>
									    <%int i=1; %>
										<!-- 注释 JSTL 循环 -->
										<c:forEach items="${requestScope.alluserlist}" var="alluserlist">
										<tr>
											<td><%=i %></td>
											<td>${alluserlist.usid }</td>
											<td>${alluserlist.uspwd }</td>
											<td>${alluserlist.usdepartment }</td>
											<td><a href="${pageContext.request.contextPath }/admin/TzdResetPwd?Usid=${alluserlist.usid }">重置密码</a></td>
										</tr>
										<%i=i+1; %>
										</c:forEach>
									</tbody>
