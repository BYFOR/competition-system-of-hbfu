							...
							<div id="dropdown-element" class="panel-collapse collapse">
								<div class="panel-body">
									<ul class="nav navbar-nav">
										...
										<li><a href="${pageContext.request.contextPath }/admin/TzXinjianJingSai">竞赛查询</a> </li>
						...
						<div class="card">
							<div class="card-header">
								<div class="card-title">
									<div class="title">竞赛特征</div>
								</div>
							</div>
							<form action="${pageContext.request.contextPath }/competition/TzdJingSaiGuanLi" method="post">
							<div class="card-body">
...
<!--  
								...
								<div class="sub-title">起始时间</div>
								<div>
									<input type="text" class="form-control" placeholder="Text input">
								</div>
								<div class="sub-title">终止时间</div>
								<div>
									<input type="text" class="form-control" placeholder="Text input">
								</div>
-->
								<div class="sub-title"></div>
								<button type="submit" class="btn btn-primary btn-info">竞赛查询</button>
							</div>
							</form>
						</div>
					</div>
