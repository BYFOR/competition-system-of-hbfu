...
<meta name="viewport" content="width=device-width, initial-scale=1">
	...
	function downloadbonus(bonuscompid,compname,department){
		var url="${pageContext.request.contextPath }/export/downloaddepartbonus?Compid="+bonuscompid+"&Compname="+compname+"&Department="+department+"";
		window.open(url);
	}
	function downloadworkload(workloadcompid,compname,department){
		var url="${pageContext.request.contextPath }/export/downloaddepartworkload?Compid="+workloadcompid+"&Compname="+compname+"&Department="+department+"";
		window.open(url);
	}
	function downloadteambonus(workloadcompid,compname,department){
        var url="${pageContext.request.contextPath }/export/downloaddepartteambonus?Compid="+workloadcompid+"&Compname="+compname+"&Department="+department+"";
		window.open(url);		
	}
							...
							<div class="card">
								<div class="card-header">
									<div class="card-title">
										<div class="title">
											<c:if test="${!empty requestScope.department }">${requestScope.department }</c:if>
										</div>
									</div>
								</div>
							</div>
									...
									<div class="tab-content"><!-- 开始 -->
										...
										<div role="tabpanel" class="tab-pane active" id="home">
											<div>
												...
												<input type="button" class="btn btn-primary btn-info1" value="导出学生奖金表" onclick="downloadbonus('${compinfo.compid }','${compinfo.compname }','${requestScope.department }')"/>
												<input type="button" class="btn btn-warning1" value="导出教师工作量表" onclick="downloadworkload('${compinfo.compid }','${compinfo.compname }','${requestScope.department }')"/>
												<input type="button" class="btn btn-primary btn-info1" value="导出队伍奖金表" onclick="downloadteambonus('${compinfo.compid }','${compinfo.compname }','${requestScope.department }')"/>												
												<%-- <span><font id="importmsg" color="red"><%=importmsg %></font></span> --%>
											</div>
										</div>
												...
												<table class="datatable table table-striped" cellspacing="0" width="100%">
													...
													<c:forEach items="${requestScope.cistulist}" var="cistulist">
														<tr>
															...
															<td> <%-- <%=student.getCardcode() %>--%>${cistulist.stucard }</td>
