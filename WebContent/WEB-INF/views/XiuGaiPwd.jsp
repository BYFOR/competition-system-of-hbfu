...
<body>
	<div class="main">
        ...
        <form action="${pageContext.request.contextPath }/admin/TzdXiuGaiPwd" method="post" class="loginform" onsubmit='return validate();'>
           <c:forEach items="${requestScope.admininfo}" var="admininfo">
           <font size="3">请输入您的工号:</font>
            <input type="text" name="Adid" id="no" value="${admininfo.adid }" readonly="true"/><br /><br />
           ...
           <font size="3">请再次输入密码:</font>
            ...
            <span id="tishi"></span>
            <br></br>
           <input type="submit" value="确定" class="blue" id="submit" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
