					...
					<div class="col-xs-12">
						<div class="card">
							...
							<c:if test="${empty requestScope.allcompetitionlist}">
								<h4 style="display:block;text-align:center">没有竞赛信息!</h4>
							</c:if>
								...
								<table class="datatable table table-striped" cellspacing="0" width="100%">
									...
									<tbody>
										...
										<tr>
											...
											<td>${allcomplist.remark }</td>
											<td><a href="${pageContext.request.contextPath }/competition/ShanChuJS?Compid=${allcomplist.compid }" onClick="return delete_confirm('${allcomplist.compname }');">删除</a></td>
										</tr>
										</c:forEach>
									</tbody>
								</table>
