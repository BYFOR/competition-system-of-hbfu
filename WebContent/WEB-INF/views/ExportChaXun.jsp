				...
				<div class="row">
					<div class="col-xs-12">
						<div class="card">
							...
							<form action="${pageContext.request.contextPath }/export/TzdExportChaXun" method="post" onsubmit="return check();">
							<div class="card-body">
								
								<div class="sub-title">竞赛编号</div>
								<div>
									<input type="text" class="form-control" placeholder="请输入竞赛编号" name="Compid" id="compid">
