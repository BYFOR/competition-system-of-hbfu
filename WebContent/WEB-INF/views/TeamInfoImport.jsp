				...
				<div class="row">
					<div class="col-xs-12">
						<div class="card">
							...
							%>
							<form action="${pageContext.request.contextPath }/team/TeamInfoImportHandle" method="post" enctype="multipart/form-data" onsubmit="return check();">
							<div class="card-body">
								<div class="sub-title">参赛队伍信息</div>
								<div>
									<input type="file" name="filename" id="excelfile" size="80"/>
									<font id="importmsg" color="red"><%=importmsg %></font>
								</div>
								
								<div class="sub-title"></div>
								<button type="submit" class="btn btn-primary btn-info" >Excel上传</button>
							</div>
							</form>
						</div>
					</div>
