...
<div class="app-container">
	<div class="row content-container">
		...
		<div class="container-fluid">
			<div class="side-body">
				<div class="page-title"> <span class="title">参赛队伍管理</span>
					<div class="description">在此界面查看、管理参赛队伍信息</div>
				</div>
				...
				<div class="row">
					<div class="col-xs-12">
						<div class="card">
							...
							<c:if test="${empty requestScope.singleteam}">
								<h4 style="display:block;text-align:center">没有该队伍的信息!</h4>
							</c:if>
							...
							<div class="card-body">
								<table class="datatable table table-striped" cellspacing="0" width="100%">
									...
									<%int i=1; %>
									<!-- 注释 JSTL 循环 -->
									<c:forEach items="${requestScope.singleteam}" var="singleteam">
										<tr>
											<td><%=i %></td>
											<td><a href="${pageContext.request.contextPath }/competition/TzdBiSaiXinXi?Id=${singleteam.competition.id }">${singleteam.competition.compname }</a></td>
											<td>${singleteam.teamid }</td>
											<td>${singleteam.smens }</td>
											<td>${singleteam.tmens }</td>
											<td>${singleteam.awlevel }</td>
											<td>${singleteam.sclevel }</td>
											<td><a href="${pageContext.request.contextPath }/team/TzXiuGaiTeam?Teamid=${singleteam.teamid }">修改</a></td>
										</tr>
										<%i=i+1; %>
									</c:forEach>	
									<!-- 注释 JSTL 循环 -->								
