						...
						<div class="card">
							<div class="card-header">
								<div class="card-title">
									<div class="title">队伍特性</div>
								</div>
							</div>
							<form action="${pageContext.request.contextPath }/team/TzdTeamGuanLi" method="post">
								<div class="card-body">
									<div class="sub-title">队伍编号</div>
									<div>
										<input type="text" class="form-control" placeholder="请输入队伍的编号" name="Teamid">
									</div>								
									<div class="sub-title"></div>
									<button type="submit" class="btn btn-primary btn-info" >队伍查询</button>
								</div>
							</form>
						</div>
					</div>
